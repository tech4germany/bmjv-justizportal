    ...
    <Box textAlign="left">
      ...
      <Hero title={t`Unser Angebot`}>
        <Trans render={Text} id="home.hero_offer">
          Justizportal.de ist ein Angebot des Bundesministeriums der Justiz und
          für Verbraucherschutz in Zusammenarbeit mit den Justizministerien der
          Länder. Das Portal gibt Ihnen einen Überblick über Ihre Rechte in
          verschiedenen Alltagssituationen. Außerdem begleitet es Sie, Ihre
          rechtlichen Fragen und Probleme einzuordnen und zu lösen. Dabei werden
          Sie über Ihre Handlungsoptionen informiert und bei der Geltendmachung
          Ihrer Rechte unterstützt.
        </Trans>
      </Hero>
        ...
        <VStack padding={[6, 12, 16]} maxWidth={800} align="start" spacing={5}>
          ...
          <Text>
            <Trans id="home.howitwork_subheading">
              Wir helfen Ihnen in vier einfachen Schritten zur Lösung Ihres
              Rechtproblems:
            </Trans>
          </Text>
          ...
          <VStack spacing={16}>
            <Feature title={t`Rechtsproblem einordnen`} icon={<FaCompass />}>
              <Trans id="home.howitwork_classify">
                Zunächst helfen wir Ihnen zu klären, ob in Ihrem Fall ein
                Rechtsproblem vorliegt. Dafür zeigen wir Ihnen auf Ihren Fall
                zugeschnittene Informationen.
              </Trans>
            </Feature>
            <Feature title={t`Über Ansprüche informieren`} icon={<FaCheck />}>
              <Trans id="home.howitwork_claims">
                Dann helfen wir Ihnen zu evaluieren, welche Ansprüche in Ihrem
                Fall vorliegen könnten. Ansprüche sind Rechte, von anderen eine
                bestimmte Handlung zu verlangen (bspw. die Zahlung von
                Schadensersatz), zu dulden (bspw. die Untervermietung einer
                Wohnung) oder zu unterlassen (bspw. das Betreten eines
                Grundstücks).
              </Trans>
            </Feature>
            <Feature
              title={t`Handlungsoptionen vergleichen`}
              icon={<FaSearch />}
            >
              <Trans id="home.howitwork_options">
                Darauf aufbauend schlagen wir Ihnen Lösungsmöglichkeiten vor -
                zunächst für eine gütliche Streitbeilegung mit der Gegenseite.{' '}
                <b>
                  Dieser Informationsservice ist für Sie komplett kostenlos.
                </b>
              </Trans>
            </Feature>
            <Feature title={t`Online Klage einreichen`} icon={<FaLandmark />}>
              <Trans id="home.howitwork_lawsuit">
                Wenn alle anderen Optionen erschöpft sind, helfen wir Ihnen
                online eine Klage beim Amtsgericht einzureichen. Dafür erklären
                wir Ihnen den Prozess unseres Online Verfahrens und zeigen
                transparent die Kosten für ein Gerichtsverfahren, sowie eine
                mögliche Rechtsberatung auf.
              </Trans>
            </Feature>
          </VStack>
          ...
          <Text align="left">
            <Trans id="home.howtohelp_footer">
              Auf den kommenden Seiten erfahren Sie mehr über die
              Rechtsprobleme, bei denen wir Sie unterstützen können.
            </Trans>
          </Text>
          <Button
            colorScheme={'secondary'}
